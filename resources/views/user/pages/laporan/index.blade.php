    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="mb-12">
            ...
            <p class="text-slate-400 italic font-medium">
                Transparansi informasi perusahaan melalui laporan publikasi resmi.
            </p>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-xl shadow-blue-900/5
            ...
            <form action="{{ url()->current() }}" method="GET"
                ...
                <div>
                    <button type="submit"
                        class="w-full bg-[#00326B] text-white font-black py-4
                               rounded-2xl shadow-lg hover:bg-blue-600
                               transition-all flex items-center justify-center
                               gap-2 uppercase text-[10px] tracking-widest">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            @forelse ($laporans as $item)
                <div
                    class="group bg-white rounded-[2rem] p-6 lg:p-8
                    ...
                    <div class="flex items-center gap-6 mb-6 md:mb-0">
                        <div
                            class="w-16 h-16 rounded-2xl bg-red-50 text-red-500
                        ...
                        <div>
                            <span
                                class="text-[9px] font-black text-blue-600 bg-blue-50
                                       px-3 py-1 rounded-lg uppercase tracking-widest
                                       mb-2 inline-block">
                                FY {{ $item->tahun }}
                            </span>
                            <h3 class="text-xl font-black text-[#00326B]">
                                {{ $item->judul }}
                            </h3>
                        </div>
                    </div>
