@php
    $isStandalone = request()->routeIs('admin.main.article.*');
    $actionRoute = $isStandalone ? route('admin.main.index') : route('admin.main.article.index');
    $actionLabel = $isStandalone ? 'Kembali ke Dashboard' : 'Kelola Artikel';
    $headerTitle = $isStandalone ? 'Kelola Artikel' : 'Preview Artikel';
@endphp
...
<div class="space-y-6">
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        {{-- PAGINATION --}}
        @if($isStandalone && $articles->hasPages())
