@php
    $isBannerPage = request()->routeIs('admin.main.banner.*');
    $actionRoute = $isBannerPage ? route('admin.main.index') : route('admin.main.banner.index');
    $actionLabel = $isBannerPage ? 'Kembali ke Dashboard' : 'Kelola Banner';
    $headerTitle = $isBannerPage ? 'Kelola Banner' : 'Banner Preview';
@endphp
...
<div class="space-y-6">
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                                    ...
                                    <form id="delete-form-banner-{{ $banner->id }}"
                                        ...
                                        <button type="button"
                                            ...
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor"
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                      d="M6 7.5h12M9 7.5V5.25A1.5 1.5 0 0110.5 3.75h3
                                                         A1.5 1.5 0 0115 5.25V7.5m-7.5 0v11.25
                                                         A1.5 1.5 0 009 20.25h6a1.5 1.5 0
                                                         001.5-1.5V7.5"/>
                                            </svg>
                                        </button>
                                    </form>
        ...
        {{-- PAGINATION --}}
        @if($isBannerPage && method_exists($banners, 'hasPages') && $banners->hasPages())
