        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative">
            ...
            <div class="max-w-4xl mx-auto text-center mb-20">
                <div class="inline-flex items-center gap-4 mb-6">
                    ...
                    <span class="text-[12px] font-black uppercase tracking-[0.5em] text-[#00326B]">
                        Local Pride & Empowerment
                    </span>
                    <span class="h-[2px] w-8 bg-[#fbbf24] rounded-full"></span>
                </div>
                <h2 class="text-5xl lg:text-7xl font-black text-[#00326B] leading-[1.1] mb-8 tracking-tighter">
                    Mitra UMKM
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#fbbf24] to-amber-500">
                        Hebat
                    </span> NTB
                </h2>
                <p class="text-slate-500 text-xl leading-relaxed max-w-2xl mx-auto font-medium italic opacity-80">
                    "Etalase karya pengusaha lokal binaan PT. BPR NTB yang mengedepankan kualitas, kreativitas, dan
                    kearifan budaya Sasak, Samawa, & Mbojo."
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                @forelse ($umkms as $umkm)
                    ...
                    @php
                        $thumbnail = $umkm->images->where('is_thumbnail', true)->first()
                            ?? $umkm->images->first();
                    @endphp
                        ...
                        <div class="p-10 flex flex-col flex-grow relative bg-white">
                            ...
                            <div class="space-y-3 mb-8">
                                <div class="flex items-start gap-3 text-slate-400">
                                    ...
                                    <span
                                        class="text-xs font-bold uppercase tracking-wider leading-relaxed">
                                        {{ $umkm->lokasi }}
                                    </span>
                                </div>
                            ...
                            <div class="mt-auto flex gap-4 pt-6 border-t border-slate-50">
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $umkm->telepon) }}"
                                    target="_blank"
                ...
                @empty
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-black text-[#00326B] uppercase tracking-widest">
                            Katalog Kosong
                        </h3>
                        <p class="text-slate-400 italic mt-2">
                            Mohon kembali lagi nanti untuk melihat mitra terbaru kami.
                        </p>
                    </div>
                @endforelse
            </div>
