...
@section('content')
    <section class="relative pt-28 pb-16 lg:pt-40 lg:pb-24 bg-[#FDFDFD] overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-full pointer-events-none">
            <div class="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-blue-50 rounded-full blur-[120px] opacity-40"></div>
            <div class="absolute bottom-[-5%] left-[-5%] w-[400px] h-[400px] bg-amber-50 rounded-full blur-[100px] opacity-30"></div>
        </div>
                ...
                <div class="lg:col-span-5 space-y-8">
                        ...
                        @if ($umkm->products->count())
                            <div class="pt-6 border-t border-slate-50">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    @foreach ($umkm->products as $produk)
                    ...
                    <div class="space-y-4">
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $umkm->telepon) }}"
                            ...
                            <span class="text-sm font-black uppercase tracking-[0.2em] relative z-10">
            ...
            <div class="mt-24">
                <div class="bg-[#00326B] rounded-[3.5rem] p-12 lg:p-20 relative overflow-hidden text-center shadow-2xl">
                    <div class="relative z-10 max-w-2xl mx-auto space-y-6">
                        ...
                        <p class="text-blue-200 text-sm font-medium opacity-80 italic">
                            "Dukung UMKM kita untuk terus tumbuh dan menggerakkan ekonomi wilayah."
                        </p>
                        <div class="pt-6">
                            <a href="#"
